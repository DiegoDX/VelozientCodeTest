...
namespace UnitTest
{
    ...
    public class DeliveryOptimizerTests
    {
        ...
        public void TestOptimizeDeliveries()
        {
            ...
            Assert.That(deliveries[0].Trips.Count, Is.GreaterThanOrEqualTo(1));
            Assert.That(deliveries[1].Trips.Count, Is.GreaterThanOrEqualTo(1));
            Assert.That(deliveries[2].Trips.Count, Is.GreaterThanOrEqualTo(1));
        }
